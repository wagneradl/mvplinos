...
`;
    ...
    execSync('NODE_OPTIONS="--max_old_space_size=4096" NEXT_SKIP_TYPECHECKING=1 next build', 
      { stdio: 'inherit', env: { ...process.env, NEXT_TYPECHECK: 'false', TSC_COMPILE_ON_ERROR: 'true' } }
    );
