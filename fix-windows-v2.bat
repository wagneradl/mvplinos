...
chcp 65001 > NUL
echo ========================================================
echo          CORRECAO DEFINITIVA PARA WINDOWS
...
echo.
echo Por favor, aguarde enquanto o sistema e reparado...
echo.
...
echo [1/8] Instalando ferramentas necessarias...
...
if exist packages\backend\src\assets\images\logo.png (
  ...
  echo [AVISO] Arquivo de logo nao encontrado.
)
echo.

REM Restaurar dependencias normais
echo [8/8] Restaurando dependencias do projeto...
cd packages\backend
call npm install
cd ..\frontend
call npm install
...
echo ========================================================
echo.
echo Agora voce pode iniciar o sistema usando:
echo.
echo Para execucao em desenvolvimento:
...
echo ========================================================
echo.
echo Gerando scripts de inicializacao simplificados...

REM Criar scripts de inicializacao simplificados
...
echo echo. >> start-all.bat
echo echo Sistema em execucao! >> start-all.bat
...
echo Scripts de inicializacao gerados:
